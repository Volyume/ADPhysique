...
### Done (32 items + the lint sweep), each: audited → researched → proposed →
...
Inventory order, next un-audited screen: **#31 `MyRecipesScreen`** (recipe list
modal), then #32 MyMeals, #33 RecipeBuilder, and the A6 You sub-stack incl. the
