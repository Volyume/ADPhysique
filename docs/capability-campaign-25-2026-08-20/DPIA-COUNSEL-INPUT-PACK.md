...
- Users may record how they train: baseline rules (their normal) and
  temporary episodes, expressed as movement-demand rules (ten-axis
  ontology), family rules, per-exercise rules and allowances. Source is
...
- Storage: device SQLite (SQLCipher-encrypted) as source of truth;
  ...
  `session_constraint_effects`; migrations 145-149 written, NOT yet in
...
- supabase/migrate_145..150 (schema + RPCs as written).
