...
# Install: copy to docs/hooks/billing-guard.sh
# Make executable: chmod +x docs/hooks/billing-guard.sh
# Wire into Claude Code settings.json as a PreToolUse hook on Write/Edit.
