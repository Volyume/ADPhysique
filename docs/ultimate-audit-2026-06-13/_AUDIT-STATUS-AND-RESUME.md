> ⚠ STATUS (2026-07-10): SUPERSEDED/CLOSED - do not build from this document. All items incl. 11-16 verified built or founder-rejected (item 15 flat timeline diary was built-and-reverted on the founder's device verdict - never re-propose) - D37. Current work runs from docs/ux-world-class-audit-2026-07-09/_HANDOVER-AND-RESUME.md and docs/TASKBOARD.md. Pre-campaign items require the D37 triage rule before any consideration.
