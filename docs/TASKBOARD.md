...
- **MIGRATIONS 176 TO 183 (2026-09-23/24) - the phrase.** All eight WRITTEN,
  ...
  and 183 are independent of the rest; 178 before any build carrying the
  "Say hello" door. Say "run against production: 176, 177, 178, 179, 180,
  181, 182, 183" (or a subset in that order). The community-notify edge
  function (the note's push copy from item 5 and the `group_accepted`
  recency bound from item 9) redeploys only by manual dispatch under the
  same phrase.
