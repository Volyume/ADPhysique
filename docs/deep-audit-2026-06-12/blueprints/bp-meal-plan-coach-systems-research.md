...
| **WAG (Working Against Gravity)** | Coach assigns macros; higher tier gives a personalised meal plan from the coach + mix-and-match ideas; client tracks in Seismic | Coach-curated within food-category groups; macro-matching is manual | Human-coach calibrated | Consumer ($99–219/mo per client: Lite $99 / Essentials $179 / Plus $219) [Corrected 2026-06-12 citation audit — was "$239–399/mo", roughly double reality; see validation/val-ext-03-06.md E6-16.] | Human-only; scale is the bottleneck |
