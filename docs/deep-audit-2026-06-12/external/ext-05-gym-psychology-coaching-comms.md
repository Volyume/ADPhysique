...
- **~12% of UK adults** find the gym intimidating (up +4 percentage points year-on-year) in PureGym's 2025/26 UK Fitness Report. [PureGym UK Fitness Report 2025/26](https://www.puregym.com/blog/uk-fitness-report-gym-statistics/) [corrected 2026-06-12 citation audit — was "~47%"; that figure conflates a US Flex survey ("47% uncomfortable exercising next to someone extremely fit"). The real PureGym figure is 12% (+4pts YoY); see P1]
...
**Social evaluation anxiety** — exercising in front of others is the primary intimidating factor for **79% of those intimidated** (+9 percentage points year-on-year). Fear of being watched, laughed at, or judged by more experienced gym-goers. [PureGym UK Fitness Report 2025/26](https://www.puregym.com/blog/uk-fitness-report-gym-statistics/) [corrected 2026-06-12 citation audit — re-sourced from ZipDo (an AI stats aggregator) to PureGym 2025/26; the figure is verified; see P7] This maps directly to the _social physique anxiety_ construct in academic literature: the apprehension people feel about others evaluating their physique.
...
Research links SDT need satisfaction to exercise adherence across populations, and SDT remains the dominant design heuristic in this field. However, the evidence is not settled law: the most recent umbrella review (Xu et al. 2025, *International Journal of Psychology* 60:e70044, [PubMed 40256835](https://pubmed.ncbi.nlm.nih.gov/40256835/)) judges the SDT–physical-activity association **inconclusive** across systematic reviews. SDT is best treated as a sound design language, not proven empirical fact. [Psychology of Sport and Exercise — SDT in Physical Activity Promotion, 2025](https://www.sciencedirect.com/science/article/pii/S1469029225000780) [corrected 2026-06-12 citation audit — the linked piece is a "contributions, debates and future directions" article in *Psychology of Sport and Exercise* (NOT a systematic review, and not in IJSEP); the "most empirically supported framework" claim is softened against Xu et al. 2025; see P10]
...
A CHI 2023 study on fitness app users (Molina et al., N=211 Hispanic users) found that **interactivity satisfied relatedness but decreased perceived autonomy and competence** — the design lever it surfaces is relatedness through interactivity, not an across-the-board preference for autonomy-supporting features. [ACM CHI 2023 — Interactivity and Relatedness in Fitness Apps](https://dl.acm.org/doi/10.1145/3544548.3581200) [corrected 2026-06-12 citation audit — the doc reversed the finding: it claimed autonomy features were "preferred across demographics"; the paper found interactivity raised relatedness while lowering autonomy and competence; see P12]
...
**Intrinsic motivation** (enjoyment, challenge, mastery, identity) predicts long-term adherence. A systematic review across 66 studies using SDT showed intrinsic motivation consistently predicted long-term exercise adherence. [Teixeira, Carraça, Markland, Silva & Ryan 2012, *IJBNPA* 9:78](https://pmc.ncbi.nlm.nih.gov/articles/PMC3441783/) [corrected 2026-06-12 citation audit — re-sourced from a gamification vendor blog (RazFit) to the actual review, Teixeira et al. 2012; see P13]

The SDT view of extrinsic motivation is more nuanced than "extrinsic = bad": motivation exists on a continuum from _external regulation_ ("I do this because I'll look bad otherwise") through _introjected regulation_ ("I do this because I'll feel guilty if I don't") and _identified regulation_ ("I do this because I've decided it matters to me") to _intrinsic regulation_ ("I do this because I love it"). Teixeira et al. 2012 found **identified regulation predicts initial, short-term adoption** more strongly, while **intrinsic motivation is the better predictor of long-term adherence**. So identified regulation — the sense that exercise aligns with your values and self-concept — is the entry scaffold, but intrinsic enjoyment is the long-game target. [corrected 2026-06-12 citation audit — the doc had this reversed, calling identified regulation "the most stable long-term predictor"; Teixeira 2012 says identified regulation predicts short-term adoption and intrinsic motivation predicts long-term adherence; see P14]
...
Gamified extrinsic rewards (badges, streaks, leaderboards) can _crowd in_ intrinsic motivation when they signal progress toward a valued identity: the cited Frontiers 2023 study (Huang, Chen & Zhou) actually found financial reward and social recognition **crowded in** intrinsic motivation for continued fitness-app use. [Frontiers — Motivation Crowding in Gamified Fitness Apps, 2023](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2023.1286463/full) [corrected 2026-06-12 citation audit — the doc cited this paper for a crowd-out/"users stop when rewards are removed" risk; that paper found crowd-in. The crowd-out concern is a real but separate literature (Deci, Koestner & Ryan 1999), not this study; see P15]
...
Specific, challenging-but-attainable goals produce better performance than vague or "do your best" goals. [Goal-Setting Theory Overview, ScienceDirect](https://www.sciencedirect.com/topics/social-sciences/goal-setting-theory) The evidence is robust in sport contexts: a 2021 systematic review confirms goal specificity and difficulty effects across sport performance studies, though effect sizes are smaller for complex, sustained behaviours than for discrete tasks. [International Review of Sport and Exercise Psychology — Goal Setting in Sport, 2021](https://www.tandfonline.com/doi/full/10.1080/1750984X.2021.1901298) [corrected 2026-06-12 citation audit — the linked DOI is in *International Review of Sport and Exercise Psychology*, not *Journal of Sports Sciences*; see P16]

**Important nuance**: a meaningful share of sport studies find specific goals are not superior to vague goals on performance outcomes [stat removed 2026-06-12 citation audit — the precise "30%+" figure was unverifiable/untraceable; see validation/val-ext-04-05-07.md P16]. The mechanism appears to be that very specific goals can increase anxiety and reduce flexibility, particularly for beginners who lack mastery experience. An "ambitious but doable" framing consistently outperforms both very easy and very hard goals.
...
Peter Gollwitzer's implementation intention research shows that "if-then" planning — specifying exactly when, where, and how you will act — substantially increases follow-through on intentions. A 2006 meta-analysis of 94 studies found a medium-to-large effect (d = 0.65) on goal attainment. [The Behavioral Scientist — Implementation Intentions](https://www.thebehavioralscientist.com/glossary/implementation-intentions) For exercise specifically, meta-analytic effects are more modest (d ≈ 0.24–0.31) but still meaningful. [Bélanger-Gravel, Godin & Amireault 2013, *Health Psychol Rev* 7(1):23–54](https://www.tandfonline.com/doi/abs/10.1080/17437199.2011.560095) [corrected 2026-06-12 citation audit — d=0.31 was pinned to PMC6440859, a 62-person pilot RCT that does not report it; the meta-analytic d≈0.24–0.31 is from Bélanger-Gravel et al. 2013; see P18]
...
In one exercise RCT, implementation intentions lifted follow-through to **91% vs ~38%** of controls (Milne, Orbell & Sheeran 2002, *BJHP* 7:163–184); meta-analytic average effects, however, are small-to-medium (see d≈0.24–0.31 above). [corrected 2026-06-12 citation audit — the "two to three times on average" claim traces to that single study, not to an average across the literature; see P19]
...
January gym-joining shows a steep decay through January and February [stat removed 2026-06-12 citation audit — the precise "80% stop going by mid-February" figure was untraceable folklore (circulating variants say "80% gone within 5 months/by June"); see validation/val-ext-04-05-07.md P23]. Foursquare's location data named ~9 February "Fall Off the Wagon Day" — when a fast-food uptick crosses the gym-visit decline. [corrected 2026-06-12 citation audit — Foursquare's date is ~9 Feb, not "the second Saturday in February"; Strava's documented analogue is "Quitter's Day", the second Friday of January; see P23] [Glofox — New Year's Resolution Gym Statistics](https://www.glofox.com/blog/6-new-years-resolution-gym-statistics-you-need-to-know/)
...
**Social support**: meta-analyses confirm social support positively predicts exercise adherence. The mechanism is via self-efficacy and commitment — having a training partner or accountability contact raises perceived capability and raises the cost of quitting. [corrected 2026-06-12 citation audit — the "peer support effect sizes of 42–59% on self-efficacy" line cited PMC9955246, which is Zou et al. 2023 (*Children* 10(2):401), a single cross-sectional survey of Chinese adolescents; the 42%/59% are mediation-path proportions (β=0.493 self-efficacy; β=0.135 direct), not meta-analytic effect sizes, so that citation cannot carry the sentence as written; the broad social-support-→-adherence direction stands on the wider literature; see P27]
...
The wider literature points to a consistent direction: autonomy support and controlling behaviour are distinct dimensions, and being supportive does not cancel out the harm of controlling language — both matter. [corrected 2026-06-12 citation audit — the cited 2018 PSE paper (PII S1469029218304424) is a situational-dependence study ("Do athletes' responses to coach autonomy support and control depend on the situation and athletes' personal motivation?"), not the source of a "high support AND low control" conclusion; that conclusion belongs to adjacent work (e.g. Haerens et al.); the claim has been softened to what the literature fairly supports; see P32] [ScienceDirect — Interactive Effects of Autonomy-Support and Control, 2018](https://www.sciencedirect.com/science/article/abs/pii/S1469029218304424)
...
A 2025 study in *Communication & Sport* (Hoffmann) analysed athletes' participation in three film sessions through a Luhmann systems-theory lens. [corrected 2026-06-12 citation audit — the journal is *Communication & Sport* (SAGE), not *Journal of Sport and Exercise Psychology*; the paper is a systems-theory analysis of three film sessions, and the doc's "seek confirmation… treating disagreement as data" gloss was an embellishment not warranted by the source; see P35] The broader point for Volyume stands as craft guidance: Eddie expects the engine's outputs to be debatable, not papal. Allowing him to log "felt off" or "went heavier than recommended" without triggering a punishment response respects this. [Communication & Sport — Athletes' Participation in Film Sessions, 2025](https://journals.sagepub.com/doi/10.1177/21674795251363419) For Volyume: Eddie expects the engine's outputs to be debatable, not papal. Allowing him to log "felt off" or "went heavier than recommended" without triggering a punishment response respects this.
...
Prevalence among competitive bodybuilders: one study found **58.3% of 120 competitive male bodybuilders scored above the MDDI cut-off** for muscle dysmorphia. [corrected 2026-06-12 citation audit — the cited paper (Devrim, Bilgic & Hongu 2018, *Am J Mens Health*, PMC6142149) reports 58.3% above the MDDI cut-off in 120 competitive male bodybuilders; neither the "up to 54%" figure nor the "13–44% lifetime in weightlifters" range appears in it; the direction (elevated risk in this population) holds; see P40] [PMC — Body Image and Eating Disorders in Male Bodybuilders, 2018](https://pmc.ncbi.nlm.nih.gov/articles/PMC6142149/)
...
The review recommends: dietary flexibility (not rigid/weighed-to-the-gram approaches), **slower rates of weight loss** (0.5–1% bodyweight per week is specifically recommended; Volyume's existing −1.5%/week safety ceiling is stricter still), structured monitoring, gradual returns to off-season intakes, internal eating cues, appropriate off-season body compositions, and access to mental health support. [corrected 2026-06-12 citation audit — the doc halved the upper bound; Helms, Prnjak & Linardon 2019, *Sports* 7(7):172 (PMC6681103) recommends 0.5–1% BW/week, not ≤0.5%; see P42]
...
- Exposure to images of idealised bodies increases body dissatisfaction among women, partly through appearance-based comparison. The experimental finding behind this — female undergraduates shown fitness images reporting more negative mood, body dissatisfaction and lower state self-esteem than those shown neutral images — is Tiggemann & Zaccardo (2015). [corrected 2026-06-12 citation audit — the undergrad finding was wrongly attributed to the Tandfonline DOI 10.1080/10410236.2022.2054099; that DOI is Sun, Huang & Jiang (*Health Communication* 38(10):2087–2098), a WeRun survey arguing that comparing *activity level* via fitness apps can *improve* body satisfaction — i.e. it cuts the opposite way; the undergrad experimental finding is Tiggemann & Zaccardo 2015 (uncited); see P43]
- A 2025 Frontiers study (Yan et al.) found that exposure to fitness posts on social media harms female body esteem, with the harm running through **body surveillance**. [corrected 2026-06-12 citation audit — the conclusion (fitness-post exposure harms female body esteem) stands, but the mechanism was misstated: Yan et al. 2025 (Front Psychol 16:1515575) attribute the harm to body surveillance; upward social comparison is only flagged as a speculative direction for future research; see P44] [Frontiers — Fitness Posts and Body Esteem, 2025](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2025.1515575/full)
...
Reframing the body around what it _does_ rather than how it _looks_ — a **performance-over-appearance framing** — is supported by the verified harm literature in this audit (the documented shame/dissatisfaction from appearance-focused fitness content, P38/P44, and the self-objectification pathway, P45): it lets the app reduce appearance-driven dissatisfaction without demanding positive feelings that users may not have. [stat removed 2026-06-12 citation audit — the specific "body neutrality shows consistent protective effects" claim cited PMC8708647, which is McCallum et al. 2021 (IJERPH), a body *positivity*/self-compassion study in a weight-management programme that does not examine body neutrality at all; it cannot carry the claim, which has been reframed to performance-over-appearance framing pending a real body-neutrality source; see validation/val-ext-04-05-07.md P46]
...
**Evidence**: Gymtimidation prevalence is 12% UK and rising (+4pts YoY, PureGym 2025/26), concentrated in Volyume's beginner persona (women 17% vs men 5%, women 25–34 worst); knowledge gaps and social evaluation anxiety account for the majority of avoidance; orientation materially reduces first-visit anxiety. [corrected 2026-06-12 citation audit — was "47% UK (PureGym 2025)"; the real PureGym 2025/26 figure is 12%; see P1]
...
**Evidence**: implementation intentions (Gollwitzer) increase exercise follow-through (in one RCT, 91% vs ~38% of controls; meta-analytic d ≈ 0.24–0.31 for exercise adherence specifically); the mechanism requires specificity of when and where, not just that you will exercise. Consistency of context is the strongest predictor of habit automaticity. [corrected 2026-06-12 citation audit — restated to match P18/P19: the "2–3×" average and the bare d=0.31 figure were over-claims; see P18, P19]
...
**Evidence**: performance-over-appearance framing is supported by the verified harm literature (shame/dissatisfaction from appearance-focused fitness content, P38/P44; self-objectification pathway, P45); performance improvements are measurable weeks before body changes; functional framing ("what your body does") reduces appearance-driven dissatisfaction without requiring unrealistic positive feelings. Particularly important given the ED safety posture and the need to welcome Besa without triggering social comparison. [corrected 2026-06-12 citation audit — the bare "body neutrality shows consistent protective effects" claim was unsupported as cited (PMC8708647 is a body-positivity study, not body neutrality); reframed to performance-over-appearance framing; see P46]
