...
| Coach outputs + APPLIED receipts | YES, converged | Deterministic co_<week>_<user> identity (v71/v72); LWW receipt preservation; legacy duplicate dropped by unique index | E2E test 7; S-16/S-22 | Cloud-side convergence completes when corrected 135 runs (HELD until v72 build live) |
