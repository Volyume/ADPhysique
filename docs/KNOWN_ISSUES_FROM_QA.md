...
|---|----------|--------|-------|--------|
| 001 | P1 | WorkoutHistoryScreen | Repeat navigates to wrong stack | Open |
| 002 | P1 | SettingsScreen | "Manage Routines" route doesn't exist | Open |
| 003 | P1 | SettingsScreen | "Volume Heatmap" uses wrong tab name | Open |
| 004 | P2 | VolumeHeatmapScreen | Includes incomplete workout sets | Open |
| 005 | P3 | WorkoutHistoryScreen | Set count includes warm-ups | Open |
| 006 | P3 | WorkoutSummaryScreen | 4-session check counts all-time | Open |
| 007 | P3 | RoutineDetailScreen | "RIR 2" jargon in seeded notes | Open |
| 008 | P4 | RoutinesScreen | Sample routine identified by name prefix | Open |
| 009 | P4 | VolumeHeatmapScreen | MEV/MAV/MRV unexplained | Open |
| 010 | P4 | VolumeHeatmapScreen | "Landmarks" jargon in UI | Open |
| 011 | P3 | ActiveWorkoutScreen | Seeded exercises missing rest/weight defaults | Open |
| 012 | P4 | RestTimer | Progress bar desync after background | Open |
| 013 | P4 | ActiveWorkoutScreen | No visual confirmation of exercise added | Open |
| 014 | P2 | AnalyticsScreen | Includes incomplete workout sets (same as #004) | Open |
| 015 | P3 | LoginScreen | OAuth buttons visible but not configured | Open |
| 016 | P4 | HomeScreen | Streak breaks on rest days | Open |
| 017 | P3 | ActiveWorkoutScreen | Progression suggestion uses silent RIR=2 | Open (accepted) |
| 018 | P3 | WorkoutSummaryScreen | No read-only mode for history view | Open |
| 019 | P4 | AnalyticsScreen | Deload warning needs 4 weeks minimum | Open (accepted) |
| 020 | P3 | MesocycleBuilderScreen | Mesocycles not connected to app logic | Open (Phase 2) |
