...
audit C-1) is DRAFTED and pending founder apply** — apply it to close the trial
extend/reset hole. Apply any future migration in numeric order in the SQL Editor.
