...
const styles = StyleSheet.create({
  ...
  card: { gap: spacing.sm },
  splitName: { color: colors.textPrimary, fontSize: fontSize.xl, fontFamily: fontFamily.heavy, fontWeight: fontWeight.heavy },
...
function buildLiveStyles(t) {
  return {
    ...
    splitName: { color: t.colors.textPrimary, fontSize: t.fontSize.xl },
