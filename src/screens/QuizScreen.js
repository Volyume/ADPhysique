...
const styles = StyleSheet.create({
  ...
  h1: { color: colors.text, fontSize: fontSize.xxl, fontWeight: fontWeight.black },
  lede: { color: colors.textSecondary, fontSize: fontSize.md, marginTop: spacing.xs, marginBottom: spacing.lg },
  section: { color: colors.text, fontSize: fontSize.lg, fontWeight: fontWeight.bold, marginTop: spacing.lg, marginBottom: spacing.sm },
