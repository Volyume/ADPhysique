    ...
    workouts: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Dumbbell Shoulder Press', sets: 3, repsMin: 10, repsMax: 15, rest: 90, notes: 'Front delt compound. Seated or standing. Full overhead range.' },
          { name: 'Dumbbell Lateral Raise', sets: 3, repsMin: 15, repsMax: 20, rest: 60, notes: 'Side delts. Pressing does not develop these. Raise to shoulder height.' },
          { name: 'Hammer Curl', sets: 2, repsMin: 10, repsMax: 15, rest: 60, notes: 'Brachialis focus. Keep elbows pinned.' },
        ],
      },
      {
        name: 'Full Body C',
        exercises: [
          ...
          { name: 'Dumbbell Rear Delt Fly', sets: 3, repsMin: 15, repsMax: 20, rest: 60, notes: 'Bent-over. Rear delts: different muscle from side delts. Slight elbow bend, slow arc.' },
