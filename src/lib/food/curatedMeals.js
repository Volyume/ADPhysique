...
export const CURATED_MEALS = Object.freeze([
  ...
  // Lunch / dinner
  m('curated_om_chicken_rice', 'Chicken & rice', 'omnivore', ['lunch', 'dinner'], [{ food: 'chicken_breast', g: 150 }, { food: 'white_rice', g: 250 }, { food: 'broccoli', g: 120 }]),
  ...
  m('curated_om_turkey_stirfry', 'Turkey mince stir-fry', 'omnivore', ['lunch', 'dinner'], [{ food: 'turkey_mince', g: 150 }, { food: 'white_rice', g: 180 }, { food: 'stirfry_veg', g: 120 }]),
  ...
  m('curated_om_chicken_sweetpot_greens', 'Chicken, sweet potato & greens', 'omnivore', ['lunch', 'dinner'], [{ food: 'chicken_breast', g: 150 }, { food: 'sweet_potato', g: 250 }, { food: 'green_beans', g: 120 }]),
  m('curated_om_chicken_jacket', 'Chicken jacket potato & salad', 'omnivore', ['lunch', 'dinner'], [{ food: 'chicken_breast', g: 140 }, { food: 'white_potato', g: 300 }, { food: 'salad', g: 80 }]),
  ...
  m('curated_veg_protein_porridge', 'Protein porridge', 'vegetarian', ['breakfast'], [{ food: 'oats', g: 60 }, { food: 'whey', g: 30 }, { food: 'milk_skimmed', g: 250 }, { food: 'berries', g: 80 }]),
  m('curated_veg_overnight_oats', 'Overnight oats', 'vegetarian', ['breakfast'], [{ food: 'oats', g: 60 }, { food: 'greek_yogurt_0', g: 100 }, { food: 'whey', g: 30 }, { food: 'milk_skimmed', g: 150 }]),
  m('curated_veg_protein_pancakes', 'Protein pancakes', 'vegetarian', ['breakfast'], [{ food: 'oats', g: 50 }, { food: 'whey', g: 30 }, { food: 'egg_whites', g: 150 }, { food: 'banana', g: 60 }]),
  ...
  m('curated_veg_skyr_berry_bowl', 'Skyr & berry bowl', 'vegetarian', ['breakfast'], [{ food: 'skyr', g: 250 }, { food: 'granola', g: 30 }]),
  ...
  m('curated_veg_quorn_chilli', 'Quorn mince chilli & rice', 'vegetarian', ['lunch', 'dinner'], [{ food: 'quorn_mince', g: 150 }, { food: 'kidney_beans', g: 100 }, { food: 'white_rice', g: 150 }, { food: 'tomato_sauce', g: 80 }]),
  m('curated_veg_quorn_bolognese', 'Quorn bolognese', 'vegetarian', ['dinner'], [{ food: 'quorn_mince', g: 150 }, { food: 'pasta', g: 70 }, { food: 'tomato_sauce', g: 120 }]),
  ...
  m('curated_vg_overnight_oats', 'Vegan protein overnight oats', 'vegan', ['breakfast'], [{ food: 'oats', g: 60 }, { food: 'soy_protein', g: 30 }, { food: 'soy_milk', g: 200 }, { food: 'berries', g: 80 }]),
  m('curated_vg_protein_pancakes', 'Vegan protein pancakes', 'vegan', ['breakfast'], [{ food: 'oats', g: 50 }, { food: 'pea_protein', g: 25 }, { food: 'soy_milk', g: 150 }, { food: 'banana', g: 60 }]),
  m('curated_vg_soy_yogurt_granola', 'Soya yogurt, granola & berries', 'vegan', ['breakfast'], [{ food: 'soy_yogurt_hp', g: 200 }, { food: 'pea_protein', g: 15 }, { food: 'granola', g: 30 }, { food: 'berries', g: 60 }]),
  m('curated_vg_pea_porridge', 'Pea protein porridge', 'vegan', ['breakfast'], [{ food: 'oats', g: 60 }, { food: 'pea_protein', g: 30 }, { food: 'berries', g: 80 }]),
  ...
  m('curated_vg_lentil_chilli', 'Lentil & bean chilli & rice', 'vegan', ['lunch', 'dinner'], [{ food: 'lentils', g: 200 }, { food: 'kidney_beans', g: 120 }, { food: 'white_rice', g: 150 }, { food: 'tomato_sauce', g: 80 }]),
  ...
  m('curated_vg_seitan_potato_greens', 'Seitan, potatoes & greens', 'vegan', ['lunch', 'dinner'], [{ food: 'seitan', g: 130 }, { food: 'white_potato', g: 250 }, { food: 'green_beans', g: 100 }]),
  m('curated_vg_seitan_noodles', 'Seitan & noodles', 'vegan', ['lunch', 'dinner'], [{ food: 'seitan', g: 130 }, { food: 'noodles', g: 200 }, { food: 'stirfry_veg', g: 120 }]),
  ...
  m('curated_vg_sn_soy_yogurt_pb', 'Soya yogurt & peanut butter', 'vegan', ['snack'], [{ food: 'soy_yogurt_hp', g: 200 }, { food: 'pea_protein', g: 15 }, { food: 'peanut_butter', g: 12 }]),
  m('curated_vg_sn_pea_shake_berries', 'Pea protein shake & berries', 'vegan', ['snack'], [{ food: 'pea_protein', g: 33 }, { food: 'berries', g: 100 }, { food: 'soy_milk', g: 200 }]),
