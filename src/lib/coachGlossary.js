...
export const GLOSSARY = {
  ...
  // `rir` (the reps-in-reserve gloss, D93) was removed on the founder's order of
  // 2026-09-22 (first given 2026-09-17): the block sheet was its only call site
  // and the block sheet does not explain reps in reserve.
  strengthLevel:
