...
export const CURATED_DEMANDS = Object.freeze({
  ...
  'Sissy Squat': { axialLoad: false, gripDemand: 'none', weightBearingHands: false },
  'Skater Squat': { axialLoad: false },
  'Smith Machine Row': { axialLoad: true },
  'Spanish Squat': { axialLoad: false, gripDemand: 'none', weightBearingHands: false },
  'Stir the Pot': { overheadPosition: false, bilateralUpper: true },
  'Tyre Flip': { overheadPosition: false, gripDemand: 'bar', unilateralLoadable: false, bilateralUpper: true, weightBearingHands: false },
  ...
  'Leg Press (Narrow Stance)': { unilateralLoadable: true },
  'Leg Press (High Foot)': { unilateralLoadable: true },
  'Leg Extension': { unilateralLoadable: true },
  'Lying Leg Curl': { unilateralLoadable: true },
  'Seated Leg Curl': { unilateralLoadable: true },
  'Standing Leg Curl': { unilateralLoadable: true },
  'Prone Leg Curl': { unilateralLoadable: true },
  'Standing Calf Raise (Machine)': { unilateralLoadable: true },
  'Seated Calf Raise': { unilateralLoadable: true },
  'Seated Machine Calf Raise': { unilateralLoadable: true },
  'Leg Press Calf Raise': { unilateralLoadable: true },
  'Calf Raise on Leg Press Sled': { unilateralLoadable: true },
  ...
  // Unilateral loadable: FALSE (two-leg or inherently bilateral)
  'Hack Squat Machine': { unilateralLoadable: false },
  'Pendulum Squat': { unilateralLoadable: false },
  'Cycling (Stationary)': { unilateralLoadable: false },
  'Machine Hip Thrust': { unilateralLoadable: false },
  'Abduction Machine': { unilateralLoadable: false },
  'Glute Ham Raise': { unilateralLoadable: false },
  'Glute-Ham Raise Machine': { unilateralLoadable: false },
  'Reverse Hyperextension': { unilateralLoadable: false },
  'Reverse Hyperextension (Glute)': { unilateralLoadable: false },
  '45-Degree Hip Extension': { unilateralLoadable: false },
  ...
  'Neck Extension (Machine)': { unilateralLoadable: false },
  'Neck Harness Flexion': { unilateralLoadable: false },
  'Neck Harness Extension': { unilateralLoadable: false },
  'Neck Machine Lateral Flexion': { unilateralLoadable: false },
  'Sled Push': { unilateralLoadable: false },
  'Sled Pull': { unilateralLoadable: false },
  'Prowler Drag': { unilateralLoadable: false },
  'Assault Bike': { unilateralLoadable: false },
  'Tyre Flip': { unilateralLoadable: false },
  'GHD Sit-Up': { unilateralLoadable: false },
  'Pec Deck (Machine Fly)': { unilateralLoadable: false },
  'Reverse Pec Deck': { unilateralLoadable: false },
  'Plate-Loaded Hip Thrust': { unilateralLoadable: false },
