...
const POOL = {
  chest: [
    ...
    { n: 'Weighted Dips (Chest)',          sub: 'lower',   p: 'mod_compound',   eq: ['full_gym', 'barbell_plates', 'home_gym'] },
  ...
  back: [
    ...
    { n: 'Weighted Pull-Up',               sub: 'vertical_pull',   p: 'heavy_compound', eq: ['full_gym', 'barbell_plates', 'home_gym'] },
  ...
  triceps: [
    ...
    { n: 'Weighted Dips (Triceps)',         sub: 'lateral',  p: 'mod_compound', eq: ['full_gym', 'barbell_plates', 'home_gym'] },
  ...
  quads: [
    ...
    { n: 'Sissy Squat',             sub: 'sweep',  p: 'isolation',      eq: ['bodyweight'] },
  ],
  hamstrings: [
    ...
    { n: 'Nordic Hamstring Curl',          sub: 'knee_flexion',  p: 'isolation',      eq: ['bodyweight'] },
  ...
  calves: [
    ...
    { n: 'Single-Leg Calf Raise (Bodyweight)', sub: 'gastro', p: 'isolation', eq: ['bodyweight'] },
  ...
  abs: [
    ...
    { n: 'Hanging Leg Raise',   sub: 'flexion',        p: 'isolation', eq: ['bodyweight'] },
    { n: 'Decline Crunch',      sub: 'flexion',        p: 'isolation', eq: ['full_gym', 'home_gym', 'barbell_plates', 'dumbbells_only', 'bodyweight'] },
    { n: 'Leg Raise (Flat Bench)', sub: 'flexion',     p: 'isolation', eq: ['bodyweight'] },
    { n: 'Ab Rollout',          sub: 'anti_extension', p: 'isolation', eq: ['bodyweight'] },
    { n: 'Plank',               sub: 'anti_extension', p: 'isolation', eq: ['bodyweight'] },
    { n: 'Side Plank',          sub: 'anti_rotation',  p: 'isolation', eq: ['bodyweight'] },
