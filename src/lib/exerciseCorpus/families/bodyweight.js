...
export default [
  ...
  },
  {
    ...
    setup: "Hang from the bar with an overhand grip, arms straight, knees tucked to your chest.",
    execution: "Roll back and under the bar until your back faces the floor and your body is level, hold, then roll back to hanging.",
  ...
  },
  {
    ...
    setup: "Stand tall with your feet hip width apart and hands on your hips or clasped in front.",
    execution: "Step one leg diagonally behind and across the other, bend both knees until the back knee nears the floor, then push through the front foot to stand.",
  ...
  },
  {
    ...
    overrides: {"difficulty":3,"demands":{"position":"mixed","floorAccess":false,"overheadPosition":true,"gripDemand":"bar","bilateralUpper":true,"unilateralLoadable":false,"balanceDemand":"high","axialLoad":false,"weightBearingHands":false}},
    setup: "Hang from the bar with an overhand grip, arms straight, knees tucked to your chest.",
    execution: "Lean back and pull the bar towards your hips until your back is level with the floor, hold, then lower to hanging.",
  ...
  },
  {
    ...
    setup: "Start on your hands with arms straight, fingers turned slightly out and shoulders leaning well over your wrists.",
    execution: "Lean further forward until your feet leave the floor and your body is level, then hold it straight for the set time.",
  ...
  },
  {
    ...
    setup: "Grip a vertical pole with one hand high, palm facing away, and the other low, palm facing in, arms straight.",
    execution: "Press through the low arm and pull with the high one to lift your straight body until it is level, hold, then lower with control.",
  ...
  },
  {
    ...
    overrides: {"laterality":"unilateral","difficulty":3,"demands":{"position":"mixed","floorAccess":false,"overheadPosition":true,"gripDemand":"bar","bilateralUpper":true,"unilateralLoadable":false,"balanceDemand":"high","axialLoad":false,"weightBearingHands":false}},
    setup: "Grip a vertical pole with one hand high, palm facing away, and the other low, palm facing in, arms straight.",
    execution: "Press through the low arm and pull with the high one to lift your hips, tuck your knees to your chest, hold near level, then lower with control.",
  ...
  },
  {
    ...
    setup: "Set up in a wide push-up position, hands well outside your shoulders and your body in one line.",
    execution: "Lower until your chest nears the floor, shift sideways over one bent arm while the other straightens, slide back across, then press up.",
