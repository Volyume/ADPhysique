...
export default [
  ...
  },
  {
    ...
    watch: "Bouncing off the block at the bottom skips the stretch that makes the rep count.",
  },
  {
    ...
    watch: "Letting your elbows wing out wide turns it back into a normal bench press.",
  },
  {
  ...
  },
  {
    ...
    watch: "Sliding your feet too far out turns it into a hamstring lift, so keep your shins upright at the top.",
  },
  {
  ...
  },
  {
    ...
    setup: "Stand over the bar set low on the rails, hinge forward at your hips and grip it just outside your knees.",
    execution: "Pull the bar towards your torso, driving your elbows back, then extend slowly.",
    watch: "Standing up as you pull turns the row into a shrug, so hold the hinge until the set ends.",
  },
  {
    ...
    watch: "Bending your arms to help the lift takes the work off your traps, so keep them straight.",
  },
  {
    ...
    execution: "Squat down keeping your torso upright, then drive back up to standing.",
    watch: "Setting your feet directly under the bar fights the fixed path, so step them slightly forward.",
  },
  // ── INTEGRATION STAGE 2 (exercise-library-expansion-2026-09-05) — generated by scripts/exercise-library/integrate-inventories.mjs; rerun the script to regenerate, do not hand-edit below this line ──
  {
    ...
    watch: "Leaning back to meet the fixed path turns it into an incline press, so set your feet further forward.",
  },
  {
  ...
  },
  {
    ...
    watch: "Setting your front foot too close to the bar cramps the bottom of each rep, so step it further out.",
  },
  {
    ...
    watch: "Pulling your elbows above shoulder height adds nothing to the delts, so stop level with them.",
  },
