...
//
// The hash itself now lives in ./exercise/canonicalId, a pure module with
// no storage or database imports, so planEngine can stamp a canonical ID on
// a generated exercise without pulling AsyncStorage into a pure engine
// (Campaign 16 job 9). Re-exported here because this is the import path the
// seed, the v18 re-id migration and the sync layer already use, and moving
// those would be churn for no gain.
// Imported AND re-exported deliberately: a bare `export ... from` would
// re-export the name without creating a local binding, and this module calls
// canonicalExerciseId itself in the seed and the top-up.
...
const SUBREGION_MAP = {
  ...
  'Cable Lat Pullover':              'shoulder_extension',
  'Cable Straight-Arm Pulldown':     'shoulder_extension',
  'Barbell Row (Bent Over)':         'upper_mid_row',
  'Dumbbell Row':                    'horizontal_lat',
  'T-Bar Row':                       'horizontal_lat',
  'Seated Cable Row':                'horizontal_lat',
  'Machine Row (Chest Supported)':   'horizontal_lat',
  'Landmine Row':                    'horizontal_lat',
  'Pendlay Row':                     'upper_mid_row',
  'Inverted Row':                    'upper_mid_row',
  'Cable High Row':                  'upper_mid_row',
  'Single-Arm Cable Row':            'horizontal_lat',
  'Meadows Row':                     'horizontal_lat',
  'Kroc Row':                        'horizontal_lat',
  'Seal Row':                        'upper_mid_row',
  'Chest-Supported Row (Dumbbell)':  'upper_mid_row',
  'Chest-Supported Row (Barbell)':   'upper_mid_row',
  'Seated Machine Row (Wide)':       'upper_mid_row',
  'Chest-Supported T-Bar Row':       'horizontal_lat',
  'Helms Row':                       'horizontal_lat',
  'Barbell Row (Supinated)':         'horizontal_lat',
  'Conventional Deadlift':           'spinal_erector',
  'Sumo Deadlift':                   'spinal_erector',
  'Rack Pull':                       'spinal_erector',
  'Trap Bar Deadlift':               'spinal_erector',
  'Snatch Grip Deadlift':            'spinal_erector',
  'Deficit Deadlift':                'spinal_erector',
  'Romanian Deadlift (Barbell)':     'hip_extension',
  'Hyperextension (Back Extension)': 'spinal_erector',
  'Reverse Hyperextension':          'spinal_erector',
  'Romanian Deadlift (Single-Leg)':  'hip_extension',
  'Stiff-Leg Deadlift (Dumbbell)':   'hip_extension',
  'Back Extension (Weighted)':       'spinal_erector',

  // Back, additional rows
  'Cable Row (Wide Grip)':           'upper_mid_row',
  'Machine Row (Hammer Strength)':   'horizontal_lat',
  'TRX Row':                         'upper_mid_row',
  ...
  'Plate-Loaded Row':                'upper_mid_row',
  'Plate-Loaded High Row':           'upper_mid_row',
  'Plate-Loaded Low Row':            'horizontal_lat',
  ...
  'Hack Squat Machine':              'squat_press',
  'Barbell Front Squat':             'squat_press',
  'Front Squat (Dumbbell)':          'squat_press',
  'Sissy Squat':                     'knee_extension',
  'Cyclist Squat':                   'squat_press',
  'Spanish Squat':                   'knee_extension',
  'Heel-Elevated Squat':             'squat_press',
  'Leg Extension':                   'knee_extension',
  'Terminal Knee Extension':         'knee_extension',
  'Pendulum Squat':                  'squat_press',
  'Leg Press (Narrow Stance)':       'squat_press',
  ...
  // Quads, sweep
  'Sissy Squat Machine':             'knee_extension',
  'Reverse Nordic Curl':             'knee_extension',
  'Smith Machine Front Squat':       'squat_press',
  ...
  // C16 job 3: back and quad entries that carried NO subregion tag and were
  // therefore falling through to the muscle default - which is how V-Bar
  // Pulldown was being counted as a row and every untagged squat variant was
  // indistinguishable from a leg extension. Tagged explicitly so the stored
  // row, the swap engine and the exercise detail screen read the same family
  // the generator does.
  'Anderson Squat':                                'squat_press',
  'Band Squat':                                    'squat_press',
  'Barbell Back Squat':                            'squat_press',
  'Barbell Lunge':                                 'squat_press',
  'Barbell Upright Row (Wide)':                    'upper_mid_row',
  'Belt Squat':                                    'squat_press',
  'Bodyweight Bulgarian Split Squat':              'squat_press',
  'Box Squat':                                     'squat_press',
  'Bulgarian Split Squat':                         'squat_press',
  'Cable Face Pull (Upper Back)':                  'upper_mid_row',
  'Cable Rope Straight-Arm Pulldown (Single-Arm)': 'shoulder_extension',
  'Cable Squat (Standing)':                        'squat_press',
  'Cambered Bar Squat':                            'squat_press',
  'Curtsy Lunge':                                  'squat_press',
  'Dumbbell Lunge':                                'squat_press',
  'Goblet Squat':                                  'squat_press',
  'Half-Kneeling Cable Row':                       'horizontal_lat',
  'Hatfield Squat':                                'squat_press',
  'Jefferson Squat':                               'squat_press',
  'Kettlebell Snatch':                             'upper_mid_row',
  'Kneeling Squat':                                'squat_press',
  'Landmine Squat':                                'squat_press',
  'Leg Press':                                     'squat_press',
  'Leg Press (High Foot)':                         'squat_press',
  'Pause Squat':                                   'squat_press',
  'Pin Squat':                                     'squat_press',
  'Reverse Lunge':                                 'squat_press',
  'SSB Squat':                                     'squat_press',
  'Safety Bar Squat':                              'squat_press',
  'Single Leg Press':                              'squat_press',
  'Skater Squat':                                  'squat_press',
  'Smith Machine Row':                             'horizontal_lat',
  'Smith Machine Squat':                           'squat_press',
  'Split Squat':                                   'squat_press',
  'Step-Up (Barbell)':                             'squat_press',
  'Step-Up (Dumbbell)':                            'squat_press',
  'Step-Up (Weighted)':                            'squat_press',
  'Sumo Squat':                                    'squat_press',
  'Tyre Flip':                                     'upper_mid_row',
  'V-Bar Pulldown':                                'vertical_pull',
  'Walking Lunge':                                 'squat_press',
  'Wall Ball Squat':                               'squat_press',
  'Wall Sit':                                      'knee_extension',
  'Wide-Grip Cable Row':                           'upper_mid_row',
  'Zercher Squat':                                 'squat_press',
};
...
// ─── Load semantics (D107-2, LOAD-SEMANTICS-SPEC) ────────────────────────────
//
// What the ENTERED weight number means for this exercise:
 ...
 * shared by the seed (new installs) and the database backfill migration
 * (existing installs), so both paths classify identically.
