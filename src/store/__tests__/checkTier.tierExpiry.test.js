/**
 * C-3 / M-3 (subscriptions audit 2026-06-08): checkTier must enforce trial
 * expiry locally at launch (so a cached pro trial that has ended downgrades
 * offline / before the cloud read), must NOT touch a paid_pro user, and must
 * no longer auto-grant pro from the legacy "first-run done" heuristic.
 */
