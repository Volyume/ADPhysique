...
const styles = StyleSheet.create({
  ...
  rowTitle: { flex: 1, color: colors.textPrimary, fontSize: fontSize.md },
  ...
  ticks: { color: colors.textPrimary, fontSize: fontSize.xl, fontWeight: fontWeight.heavy, fontVariant: ['tabular-nums'] },
  ...
  sheetTitle: { color: colors.textPrimary, fontSize: fontSize.xxl, fontWeight: fontWeight.black, marginBottom: spacing.xs },
  ...
  codeInput: { flex: 1, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, color: colors.textPrimary, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, minHeight: 44 },
