...
const styles = StyleSheet.create({
  ...
  // D174 A2: picking which scan to read is choosing a VIEW, so the selected
  // chip is the neutral raised fill with its ink lifted, not an amber slab.
  scanChipActive: { backgroundColor: colors.surface3 },
  scanChipDate: { ...type.caption, color: colors.textMuted },
  scanChipDateActive: { color: colors.textSecondary },
  scanChipRange: { ...type.bodyStrong, color: colors.textPrimary, lineHeight: 20 },
  scanChipRangeActive: { color: colors.textPrimary },
  summaryRow: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  // D165 law 2: a stat panel, not an object -- no box, a borderSubtle hairline above (D171/D172).
  summaryPanel: {
    flex: 1,
    minWidth: 142,
    padding: spacing.md,
  ...
  // A scan's range is a figure, not the user's live moment: discipline 1
  // grants amber to a personal best, never to every reading.
  summaryRange: { ...type.h3, color: colors.textPrimary, lineHeight: 25 },
  summaryConfidence: { ...type.title, color: colors.textSecondary },
  summaryMeta: { ...type.caption, color: colors.textMuted, lineHeight: 18 },
  // D174: "Why this looks different" is a callout. The wash goes and the
  // hairline carries it, exactly as ActiveWorkoutScreen's cluster banner and
  // HomeScreen's quick-start card were rebuilt.
  deltaBox: {
  ...
  deltaLabel: { ...type.caption, color: colors.textPrimary, fontWeight: fontWeight.semibold },
...
function buildLiveStyles(t) {
  return {
    ...
    scanChipActive: { backgroundColor: t.colors.surface3 },
    scanChipDate: { color: t.colors.textMuted },
    scanChipDateActive: { color: t.colors.textSecondary },
    scanChipRange: { color: t.colors.textPrimary },
    scanChipRangeActive: { color: t.colors.textPrimary },
    summaryPanel: { borderTopColor: t.colors.borderSubtle },
    summaryLabel: { color: t.colors.textMuted },
    summaryDate: { color: t.colors.textPrimary },
    summaryRange: { color: t.colors.textPrimary },
    summaryConfidence: { color: t.colors.textSecondary },
    summaryMeta: { color: t.colors.textMuted },
    deltaBox: { backgroundColor: t.colors.surface, borderColor: t.colors.borderSubtle },
    deltaLabel: { color: t.colors.textPrimary },
