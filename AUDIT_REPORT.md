...
- `Chip` now supports explicit accessibility labels and label style overrides; Settings Profile sex/diet radio groups, Coaching Reminders day/hour selectors and CancelReasonSheet break-window options use it instead of bespoke chips.
